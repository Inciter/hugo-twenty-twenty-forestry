...
font_color = "#ffffff"
font_size = 1.25
left_content = "<p>that to get the reports they need, they have to buy an expensive new system. That means moving all their data over to a new system, getting everyone trained and willing to USE the new system, and working out all the bugs that come along with a project like that.</p>"
left_headline = "Most people Think"
left_side = ""
right_content = "<p>You can get accurate and effortless reports without changing a thing.</p>"
right_headline = "Guess what?"
right_side = ""
